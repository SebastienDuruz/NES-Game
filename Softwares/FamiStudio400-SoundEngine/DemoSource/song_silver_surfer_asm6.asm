...
@song0ch0loop:
	db $4b, $46, <(@tempo_env_6_mid), >(@tempo_env_6_mid), $7f, $4a, <(@env18), >(@env18), $a4, $19, $c5, $4a, <(@env1), >(@env1)
	...
	db $20, $95, $47, $74, $4a, <(@env46), >(@env46), $96, $1c, $ff, $bd, $4a, <(@env23), >(@env23), $1c, $ff, $bd, $47, $7f
...
@song0ref165:
	...
	db $4a, <(@env49), >(@env49), $1f, $ad, $4a, <(@env25), >(@env25), $1f, $ad, $47, $4a, <(@env16), >(@env16), $43, $1f, $dd
	db $4a, <(@env2), >(@env2), $20, $dd, $4a, <(@env34), >(@env34), $1d, $dd, $4a, <(@env49), >(@env49), $1f, $ad, $4a, <(@env25)
	db >(@env25), $1f, $ad, $47, $4a, <(@env16), >(@env16), $43, $1f, $dd, $4a, <(@env2), >(@env2), $20, $dd, $4a, <(@env34)
	db >(@env34), $1d, $dd, $4a, <(@env49), >(@env49), $1f, $ad, $4a, <(@env25), >(@env25), $1f, $ad, $47, $4a, <(@env16), >(@env16)
	db $43, $1f, $dd, $4a, <(@env2), >(@env2), $20, $dd, $4a, <(@env34), >(@env34), $1d, $dd, $4a, <(@env49), >(@env49), $1f
...
@song0ch1loop:
	...
	db $91, $72, $4f, $13, $33, $2c, $91, $74, $28, $29, $2a, $89, $48, <(@env62), >(@env62), $9d, $48, <(@env0), >(@env0), $49
	db $81, $2b, $2c, $8d, $48, <(@env62), >(@env62), $ff, $83, $48, <(@env0), >(@env0), $49, $81, $4f, $0c, $38, $32, $91, $72
	db $4f, $0c, $38, $32, $91, $74, $9a, $30, $31, $9b, $4f, $0f, $3d, $34, $91, $72, $4f, $0f, $3d, $34, $91, $74, $32, $33
	db $9b, $4f, $16, $3f, $32, $91, $72, $4f, $16, $3f, $32, $91, $74, $34, $35, $36, $89, $48, <(@env62), >(@env62), $9d, $48
	db <(@env0), >(@env0), $49, $81, $37, $38, $8d, $48, <(@env62), >(@env62), $ff, $83, $48, <(@env0), >(@env0), $49, $81, $4f
	db $0d, $44, $39, $91, $72, $4f, $0d, $44, $39, $91, $74, $98, $37, $38, $9b, $4f, $0f, $44, $38, $91, $72, $4f, $0f, $44
	db $38, $91, $74, $39, $3a, $9b, $4f, $14, $46, $36, $91, $72, $4f, $14, $46, $36, $91, $74, $3b, $3c, $3d, $87, $48, <(@env62)
	db >(@env62), $9f, $48, <(@env0), >(@env0), $49, $81, $3e, $3f, $8d, $48, <(@env62), >(@env62), $ff, $83, $48, <(@env0), >(@env0)
	db $49, $81, $4f, $0c, $4b, $3d, $91, $72, $4f, $0c, $4b, $3d, $91, $00, $95, $74, $3a, $3b, $97, $48, <(@env62), >(@env62)
	db $f9, $48, <(@env0), >(@env0), $49, $81, $4f, $0c, $47, $3b, $91, $72, $4f, $0c, $47, $3b, $91, $74, $3c, $3d, $8d, $48
	db <(@env62), >(@env62), $ff, $81, $48, <(@env0), >(@env0), $49, $81, $4f, $0b, $49, $3c, $93, $72, $4f, $0c, $49, $3c, $91
	db $7f, $ae
@song0ref982:
